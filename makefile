...
CPPFLAGS               = -Wall    # helpful for writing better code (behavior-related)
...
LDFLAGS_MACOS          =
EXTRA_CFLAGS_LINUX     =
EXTRA_LDFLAGS_LINUX    = #-Wl,--gc-sections
...
CFLAGS  = #-O3
CXXFLAGS= -std=c++20 -g -O3 -Wno-unused-function
